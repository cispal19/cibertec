...
public class ConsultarNotas extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        List<Notas> listaNotas = notaService.consultarNotaByDniAlumno(notas);
        listar(listaNotas);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultarNotas consulta = new ConsultarNotas();
                consulta.setCtx(new AnnotationConfigApplicationContext(com.cispal.siscolegio.ApplicationContext.class));
