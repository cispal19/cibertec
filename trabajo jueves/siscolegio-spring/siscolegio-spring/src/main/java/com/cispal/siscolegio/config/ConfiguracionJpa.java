package com.cispal.siscolegio.config;
...
public class ConfiguracionJpa {
    ...
    private static final String[] ENTITYMANAGER_PACKAGES_TO_SCAN = {"com.cispal.siscolegio.domain"};
    ...
    @Value("${jpa.hibernate.hbm2ddl}")
    private String hb2mdll;
    ...
    private Properties jpaHibernateProperties() {
        ...
        properties.put(PROPERTY_NAME_HIBERNATE_HBM2DDL,hb2mdll);
